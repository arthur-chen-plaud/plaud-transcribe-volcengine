...
VOLCENGINE_SUBMIT_RETRY_DELAYS = os.getenv("VOLCENGINE_SUBMIT_RETRY_DELAYS", "0,2,10")
VOLCENGINE_WARMUP_URL = os.getenv("VOLCENGINE_WARMUP_URL", "")
VOLCENGINE_MOCK_MODE = os.getenv("VOLCENGINE_MOCK_MODE", "false").lower() in ("1", "true", "yes", "on")
VOLCENGINE_MOCK_TEXT = os.getenv("VOLCENGINE_MOCK_TEXT", "mock volcengine asr result")
